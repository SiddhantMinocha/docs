...
Associate diseases with your panel by searching disease names. Disease links help document the clinical phenotype your panel targets and improve Nexus's ability to contextualize variants.

## Using your panel

Apply panels in two ways:

**From chat** — Ask Nexus directly: "Find loss-of-function variants in my cardiomyopathy panel." Nexus retrieves and filters variants accordingly.

**From the variant browser** — Open the **Virtual Panels** filter in the [Variants tab](/guides/variant-analysis) and select your panel. Nexus filters the dataset to show only variants in those genes.
