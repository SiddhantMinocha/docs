...
Nexus supports ACMG/AMP variant classification with 28 standard criteria. The ACMG tab in the [variant detail panel](/guides/variant-detail) displays active criteria, evidence summaries, and tools for both AI-enhanced and manual classification.
...
Click **AI Enhance** to begin. Nexus initiates the analysis and begins gathering evidence.

### Step 2: Running

Nexus evaluates the variant against ACMG criteria using evidence from multiple sources:
